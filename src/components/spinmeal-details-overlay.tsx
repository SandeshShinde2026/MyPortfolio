...
export function SpinMealDetailsOverlay() {
  const { activeApp, closeApp } = useOsStore();
  const [mobileSheetOpen, setMobileSheetOpen] = useState(false);

  const isSpinMeal = activeApp === "project-spinmeal";
    ...
    <>
      <div>
        <h1 className="text-[3.5rem] leading-[0.9] font-black text-white mb-6 tracking-tighter uppercase drop-shadow-2xl font-sans">
          SpinMeal<span className="text-white/30">.</span>
        </h1>
        <p className="text-[15px] text-white/80 leading-relaxed font-normal tracking-wide">
          SpinMeal is a native mobile experience that helps users quickly decide what to eat through a fun, interactive spinning wheel. Reduce decision fatigue and make mealtime exciting again.
        </p>

        <div className="flex flex-wrap gap-3 mt-8">
          <a href="https://play.google.com/store/apps/details?id=com.svnate.spinmeal" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2.5 px-6 py-3 bg-white text-black rounded-full text-[10px] font-black tracking-[0.2em] uppercase hover:scale-105 transition-transform">
          ...
          <a href="https://apps.apple.com/us/app/spinmeal/id6765926995" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2.5 px-6 py-3 bg-white text-black rounded-full text-[10px] font-black tracking-[0.2em] uppercase hover:scale-105 transition-transform">
          ...
          <a href="https://spinmeal.svnate.com/" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2.5 px-6 py-3 bg-white/[0.05] border border-white/10 text-white rounded-full text-[10px] font-black tracking-[0.2em] uppercase hover:bg-white/10 transition-colors">
      ...
      <div>
        ...
        <p className="text-[15px] text-white/80 leading-relaxed font-normal">
          People often waste time deciding what to eat, especially with friends or groups. Endless "you decide" conversations make food selection frustrating and time-consuming.
        </p>
      </div>
    </>
  );
  ...
  const RightContent = (
    <>
      <div>
        ...
        <p className="text-[15px] text-white/80 leading-relaxed font-normal">
          SpinMeal makes meal decisions instant and interactive by letting users spin and randomly choose food options based on their preferences, mood, or cravings in seconds.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="grid grid-cols-1 gap-3 text-[14px] text-white/80 font-normal">
          {[
            "Interactive food spinning wheel",
            "Random meal suggestions in seconds",
            "Customizable food categories and choices",
            "Smooth native mobile experience",
            "Fast and simple UI focused on quick decisions",
          ].map((feature, i) => (
  ...
  return (
    <>
      {/* Global Close Button for SpinMeal */}
      <AnimatePresence>
        {isSpinMeal && !mobileSheetOpen && (
          <motion.button
            key="global-close"
      ...
      <AnimatePresence>
        {isSpinMeal && !mobileSheetOpen && (
          ...
          >
            ...
            <a 
              href="https://play.google.com/store/apps/details?id=com.svnate.spinmeal" 
              target="_blank" 
              rel="noreferrer" 
            ...
            <a 
              href="https://apps.apple.com/us/app/spinmeal/id6765926995" 
              target="_blank" 
              rel="noreferrer" 
              className="pointer-events-auto w-[46px] h-[46px] bg-[#111] backdrop-blur-xl border border-white/10 rounded-full flex items-center justify-center text-white active:scale-95 transition-transform shadow-xl hover:bg-[#222]"
              title="App Store"
            ...
            <a 
              href="https://spinmeal.svnate.com/" 
              target="_blank" 
              rel="noreferrer" 
              className="pointer-events-auto w-[46px] h-[46px] bg-[#111] backdrop-blur-xl border border-white/10 rounded-full flex items-center justify-center text-white active:scale-95 transition-transform shadow-xl hover:bg-[#222]"
              title="Website"
